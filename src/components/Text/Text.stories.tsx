...
// Define Meta information for the Text component
const meta: Meta = {
  title: 'Components/Text', // Provide a title for your storybook
  component: Text,
  parameters: {
    componentSubtitle: 'A component for displaying text.',
  },
};
